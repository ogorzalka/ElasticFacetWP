...
class ElasticFacetWP {
	...
	public function __construct() {
		add_filter( 'facetwp_query_args', array( $this, 'search_query_args' ), 10, 2 );
		add_filter( 'ep_formatted_args', array( $this, 'fix_facetwp_order' ), 10, 2 );
		add_filter( 'facetwp_settings_admin', array( $this, 'filter_prefix' ), 10, 1 );
	}
...
register_activation_hook( __FILE__, array( 'ElasticFacetWP', 'activate' ) );
register_deactivation_hook( __FILE__, array( 'ElasticFacetWP', 'deactivate' ) );
